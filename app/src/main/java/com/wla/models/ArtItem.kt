...
data class ArtItem(
    val id: Int,
    val type: MainViewModel.ObjectType = MainViewModel.ObjectType.DEFAULT,
    var isLoading: Boolean = false,
) :
    Parcelable {
    companion object {
        fun default() = mutableListOf(ArtItem(R.string.default_state))
        fun loading(isLoading: Boolean) = mutableListOf(ArtItem(R.string.loading_state,
            MainViewModel.ObjectType.LOADING,
            isLoading))
